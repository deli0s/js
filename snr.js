...
function exportCalendar() {
	...
	for (let i = 0; i < series.length; i ++) {
		...
		if (isAnime) {
			...
			serie.outerHTML+=`</div><div style="display: inline; position: absolute; cursor: pointer; margin-top: 30px;"><a style="text-decoration: none;" href="https://9anime.to/filter?keyword=${title.replaceAll(' ', '+')}&type=2&status=2&season=&language=&sort=all&year=&genre=">🔗</a>`;
		}
	}
