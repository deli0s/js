...
function exportCalendar() {
	...
	for (let i = 0; i < series.length; i ++) {
		...
		if (isAnime) {
			...
			serie.outerHTML+=`</div><div style="display: inline; position: absolute; cursor: pointer; margin-top: 30px;"><a style="text-decoration: none;" href="https://9anime.to/filter?keyword=${title.replaceAll(' ', '+')}&country%5B%5D=120822&type%5B%5D=tv&status%5B%5D=releasing&sort=most_relevance">🔗</a>`;
		}
	}
