		...
		if (existeix(videos)){
			...
			for (var i_video=0; i_video<size_videos; i_video++){
				...
				if (existeix(video)){
					...
					if (existeix(watched) || t_(video,"Late Motiv","Broncano,Berto,Romero,ignatius") || t_(video,"TERRAT","NADIE SABE NADA") || t_(video,"manga","Titan") || t_(video,"Oh! My LOL"," Moderna") || t_(video,"WIRED","Answer") || t_(video,"Anochece","tonacho")){
